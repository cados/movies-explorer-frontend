      ...
      <div className="aboutMe__textbox">
        <div>
          ...
          <p className="aboutMe__text">
            Я родился в маленьком городке на Донбассе, сейчас живу в Москве . В свое время постигал гранит науки в  колледже, потом в институте по it-ым специальностям, но применения полученных знаний так и не нашел  в реальной жизни, хотя от it я никогда не отходил. Все время занимался фрилансом и саморазвитием. После того, как прошёл курс по веб-разработке я начинаю свой новый путь в качестве фронтенд разработчика.</p>
          <a
